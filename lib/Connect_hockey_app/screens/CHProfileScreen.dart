...
import 'package:connect_hockey/Connect_hockey_app/utils/CHStyle.dart' as SD;
import 'package:connect_hockey/Connect_hockey_app/screens/CHSettingScreen.dart';

import 'CHEditProfileScreen.dart';
...
class _sdPRofileScreenState extends State<sdPRofileScreen> {
  ...
  Widget build(BuildContext context) {
    changeStatusColor(chPrimaryColor);
                  ...
                  GestureDetector(
                    ...
                    child: FittedBox(
                      child: Container(
                        ...
                        child: Center(
                          child: Text('Edit Profile', style: boldTextStyle(size: 12, color: chPrimaryColor)),
                        ),
                      ),
                    ),
                  )
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            '67',
                            style: boldTextStyle(color: chSecondaryColorYellow.withOpacity(0.7), size: 26),
                          ),
                          SizedBox(height: 10),
