...
class CHChatPageViewScreen extends StatefulWidget {
  String name;
  String profileImages;

  CHChatPageViewScreen({this.name, this.profileImages});

  @override
  _CHChatPageViewScreenState createState() => _CHChatPageViewScreenState();
}

class _CHChatPageViewScreenState extends State<CHChatPageViewScreen> {
      ...
      Align(
        ...
        child: FittedBox(
          child: Container(
            ...
            decoration: boxDecorations(bgColor: chViewColor),
                        ...
                        Container(
                          ...
                          child: PopupMenuButton(
                            ...
                            itemBuilder: (BuildContext context) => [
                              PopupMenuItem(value: 1, child: Text("View Friend")),
