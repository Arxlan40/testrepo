...
import 'package:connect_hockey/Connect_hockey_app/models/CHChatsModel.dart';
import 'package:connect_hockey/Connect_hockey_app/utils/CHColors.dart';
import 'package:connect_hockey/Connect_hockey_app/screens/CHChatPageViewScreen.dart';

class CHChatScreen extends StatefulWidget {
  @override
  _CHChatScreenState createState() => _CHChatScreenState();
}

class _CHChatScreenState extends State<CHChatScreen> with SingleTickerProviderStateMixin {
  ...
  List<CHChatsModel> personalChats = [
    CHChatsModel(
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Center(child: Text('Chatroom', style: boldTextStyle(color: Colors.white))),
              ),
              Column(
                children: <Widget>[
                  Container(
                                    ...
                                    children: <Widget>[
                                      ...
                                      personalChats[index].pendingMessages != null
                                          ? Container(
                                              ...
                                              height: 22,
                                              width: 22,
                                              decoration: BoxDecoration(color: chSecondaryColorRed, borderRadius: BorderRadius.all(Radius.circular(25.0))),
                                              child: Center(
