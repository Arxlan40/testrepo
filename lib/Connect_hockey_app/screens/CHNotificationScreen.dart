import 'package:connect_hockey/Connect_hockey_app/models/CHNotidicationModel.dart';
import 'package:connect_hockey/Connect_hockey_app/utils/CHColors.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:nb_utils/nb_utils.dart';

class CHNotificationScreen extends StatefulWidget {
  @override
  _CHNotificationScreenState createState() => _CHNotificationScreenState();
}

class _CHNotificationScreenState extends State<CHNotificationScreen> {
  List<CHNotidicationModel> notification = [
    CHNotidicationModel(
  ...
  Widget build(BuildContext context) {
    Widget mPopup() => PopupMenuButton(
          ...
          child: Container(
            ...
            child: Icon(Icons.more_vert, color: chTextPrimaryColor),
          ),
        );
