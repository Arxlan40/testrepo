...
import 'package:connect_hockey/Connect_hockey_app/models/CHAllExerciceTrainingModel.dart';
...
class _SdViewAllLiveVideoScreenState extends State<SdViewAllLiveVideoScreen> with SingleTickerProviderStateMixin {
  List<CHAllExerciceTrainingModel> liveVideo = [
  ...
  void initState() {
    ...
    tabs = ['On-Ice', 'Off-Ice', 'Visualization'];
  ...
  Widget build(BuildContext context) {
    Widget mList(CHAllExerciceTrainingModel mLiveVideo) {
      return Container(
                ...
                children: <Widget>[
                  ...
                  FittedBox(
                    child: Container(
                      ...
                      decoration: boxDecorations(bgColor: chSecondaryColorRed, radius: 4),
    ...
    return SafeArea(
      child: Scaffold(
        body: Stack(
          children: [
            Container(color: chPrimaryColor, height: MediaQuery.of(context).size.width * 0.5),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Container(
                  margin: EdgeInsets.only(top: 16, left: 16),
                  child: Text('All Exercices', style: boldTextStyle(color: Colors.white)),
                ),
                SizedBox(height: 10),
                Padding(
