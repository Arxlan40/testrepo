...
class MWSwitchScreenRebound extends StatefulWidget {
  static String tag = '/MWSwitchScreen';

  @override
  MWSwitchScreenReboundState createState() => MWSwitchScreenReboundState();
}

class MWSwitchScreenReboundState extends State<MWSwitchScreenRebound> {
                ...
                Card(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Rebound', style: primaryTextStyle()),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Switch(
                            ...
                            Text('$reboundOrNo', style: TextStyle(color: appStore.textSecondaryColor, fontSize: 16)),
                          ],
                        ),
                      ],
                    ),
