...
class CHCarouselSlider extends StatefulWidget {
  CHCarouselSlider(
      {@required this.items,
      this.height,
  ...
  @override
  _CHCarouselSliderState createState() => _CHCarouselSliderState();
}


class _CHCarouselSliderState extends State<CHCarouselSlider> with TickerProviderStateMixin {
  Timer timer;
