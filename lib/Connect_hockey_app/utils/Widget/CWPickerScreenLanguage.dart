...
class CWPickerScreenLanguage extends StatefulWidget {
  static String tag = '/CWPickerScreen';

  @override
  CWPickerScreenLanguageState createState() => CWPickerScreenLanguageState();
}

class CWPickerScreenLanguageState extends State<CWPickerScreenLanguage> {
  List<ListModel> example = [
    ListModel(name: 'Select Language')
  ];
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('Done', style: primaryTextStyle(size: 18)).onTap(() {
                      setState(() {language=selectedValue;});
                      finish(context);
