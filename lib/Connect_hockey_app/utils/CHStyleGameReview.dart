...
BoxDecoration boxDecoration({double radius = 80.0, Color backGroundColor = chPrimaryColor, double blurRadius = 8.0, double spreadRadius = 8.0, shadowColor = Colors.black12}) {
...
Widget profileCard() {
  return Container(
    decoration: boxDecoration(radius: 16, shadowColor: chPrimaryColor.withAlpha(30)),
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Text(
            'Edit',
            style: primaryTextStyle(color: chPrimaryColor, size: 16),
          ),
        ),
      ],
    ),
    ...
    child: Row(
      children: [
        Icon(
          icon,
          size: 20,
          color: chShadowColor.withOpacity(0.6),
        ),
        SizedBox(
          width: 16,
        ),
...
Widget oPDotIndicator({bool isActive}) {
  return AnimatedContainer(
    ...
    decoration: BoxDecoration(
      color: isActive ? chPrimaryColor : Colors.grey.withOpacity(0.5),
      borderRadius: BorderRadius.all(Radius.circular(50)),
    ),
  );
}
